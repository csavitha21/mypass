...
public class ProjectTrainingService {
    ...
    public void loadData() {
        ...
        Worker worker11 = new Worker(UUID.randomUUID().toString(), "Sam", qualifications11, trainingPrograms11, "/projects/workers/");
        ...
        Worker worker12 = new Worker(UUID.randomUUID().toString(), "Paul", qualifications12, trainingPrograms12, "/projects/workers/");
        ...
        Worker worker13 = new Worker(UUID.randomUUID().toString(), "John", qualifications13, trainingPrograms13, "/projects/workers/");
        ...
        List<TrainingProgram> trainingPrograms14 = Arrays.asList(new TrainingProgram(UUID.randomUUID().toString(), "Front-end development", "15/03/2024", "Completed"),
                new TrainingProgram(UUID.randomUUID().toString(), "Back-end development", "15/12/2024", "In-Progress"));
        Worker worker14 = new Worker(UUID.randomUUID().toString(), "Sam", qualifications14, trainingPrograms14, "/projects/workers/");
        ...
        Worker worker15 = new Worker(UUID.randomUUID().toString(), "Paul", qualifications15, trainingPrograms15, "/projects/workers/");
        ...
        Worker worker16 = new Worker(UUID.randomUUID().toString(), "John", qualifications16, trainingPrograms16, "/projects/workers/");
        ...
        List<TrainingProgram> trainingPrograms17 = Arrays.asList(new TrainingProgram(UUID.randomUUID().toString(), "Front-end development", "15/03/2024", "Completed"),
                new TrainingProgram(UUID.randomUUID().toString(), "Back-end development", "15/12/2024", "In-Progress"));
        Worker worker17 = new Worker(UUID.randomUUID().toString(), "Sam", qualifications17, trainingPrograms17, "/projects/workers/");
        ...
        Worker worker18 = new Worker(UUID.randomUUID().toString(), "Paul", qualifications18, trainingPrograms18, "/projects/workers/");
        ...
        Worker worker19 = new Worker(UUID.randomUUID().toString(), "John", qualifications19, trainingPrograms19, "/projects/workers/");
        ...
        Worker worker21 = new Worker(UUID.randomUUID().toString(), "Peter", qualifications21, trainingPrograms21, "/projects/workers/");
        ...
        Worker worker22 = new Worker(UUID.randomUUID().toString(), "Ira", qualifications22, trainingPrograms22, "/projects/workers/");
    ...
    public List<Worker> getWorkerDetailsForProjectId(String projectId, String qualificationName, String trainingProgramName, int page, int size) {
        ...
        if (project.isPresent()) {
            ...
            int start = (page) * size;
            int end = Math.min(start + size, filteredWorkers.size());

            if (start > end) {
                return List.of();
            }
            return filteredWorkers.subList(start, end);
